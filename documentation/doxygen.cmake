...
if(NOT DOXYGEN_OUTPUT_DIR)
  set(DOXYGEN_OUTPUT_DIR ${CMAKE_BINARY_DIR}/docs CACHE STRING "Output direcotry for Doxygen documentation.")
endif()

if(NOT DOXYGEN_INPUT_DIRS)
  set(DOXYGEN_INPUT_DIRS src docs README.md CACHE STRING "Input files and folders used to generate Doxygen documentation.")
endif()
...
if(DOXYGEN)
  ...
  message("[WARNING] Doxygen not installed. Documentationt argets are disabled.")
endif()
